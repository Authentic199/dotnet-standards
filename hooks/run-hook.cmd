...
REM
REM Hook scripts use extensionless filenames (e.g. "post-edit-format" not
REM "post-edit-format.sh") so Claude Code's Windows auto-detection -- which
REM prepends "bash" to any command containing .sh -- doesn't interfere.
REM
REM Usage: run-hook.cmd <script-name> [args...]
REM
REM Pattern copied (not referenced) from obra/superpowers, MIT -- see NOTICE.
REM Referencing another plugin's internal path would couple the two plugins,
...
REM No bash found - exit silently rather than error (see note above)
exit /b 0
CMDBLOCK
